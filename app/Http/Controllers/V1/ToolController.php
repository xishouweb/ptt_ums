...
免费领取: http://tinyurl.com/yy82vqc9',
    ...
    private function __get24hChangeFromMxcWith($symbol)
    {
        try{
            ...
            if ($cache = DataCache::getSymbolInfo('symbol-info-mxc-' . $symbol)) {
                return isset($cache['percentChange']) ? $cache['percentChange'] * 100 : 0;
            }
